...
# [Simple](https://github.com/ArminJo/ServoEasing/blob/master/examples/Simple/Simple.ino)
...
# [SimpleCallback](https://github.com/ArminJo/ServoEasing/blob/master/examples/SimpleCallback/SimpleCallback.ino)
This example shows the usage of a callback function for multiple moves independent of the main loop function.<br/>

# [OneServo](https://github.com/ArminJo/ServoEasing/blob/master/examples/OneServo/OneServo.ino)
...
## [PCA9685_Expander](https://github.com/ArminJo/ServoEasing/blob/master/examples/OneServo/OneServo.ino#L28)
...
# [SymmetricEasing](https://github.com/ArminJo/ServoEasing/blob/master/examples/SymmetricEasing/SymmetricEasing.ino)
...
# [AsymmetricEasing](https://github.com/ArminJo/ServoEasing/blob/master/examples/AsymmetricEasing/AsymmetricEasing.ino)
...
# [ContinuousRotatingServo](https://github.com/ArminJo/ServoEasing/blob/master/examples/ContinuousRotatingServo/ContinuousRotatingServo.ino)
...
# [LightweightServoExample](https://github.com/ArminJo/ServoEasing/blob/master/examples/LightweightServoExample/LightweightServoExample.ino)
This example moves 2 servos attached at pin 9 and 10 using the LightweightServo library for ATmega328*.

# [CatMover](https://github.com/ArminJo/ServoEasing/blob/master/examples/CatMover/CatMover.ino)
...
# [RobotArmControl](https://github.com/ArminJo/ServoEasing/blob/master/examples/RobotArmControl/RobotArmControl.ino)
...
# [PCA9685_ExpanderAndServo](https://github.com/ArminJo/ServoEasing/blob/master/examples/PCA9685_ExpanderAndServo/PCA9685_ExpanderAndServo.ino)
...
# [PCA9685_ExpanderFor32Servos](https://github.com/ArminJo/ServoEasing/blob/master/examples/PCA9685_ExpanderFor32Servos/PCA9685_ExpanderFor32Servos.ino)

...
If you have a PCA9685 expander using external clock input, you must call `PCA9685InitWithExternalClock(uint32_t aExternalClockFrequencyHertz)` after the last attach.

...
#  if defined(USE_SERVO_LIB)
    if (mServoIsConnectedToExpander) {
        ...
        Servo::writeMicroseconds(aValue); // requires 7 µs
    }
#  else
    /*
...
//@formatter:on
/*
 * 60 µs for single servo + 160 µs per servo if using I2C e.g.for PCA9685 expander at 400000 Hz or + 100 at 800000 Hz
